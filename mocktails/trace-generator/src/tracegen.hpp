#ifndef MOCKTAILS_CLONING_TRACEGEN_HPP
#define MOCKTAILS_CLONING_TRACEGEN_HPP

#include <string>

/**
 * Create a synthetic trace based on the Mocktails statistical profile.
 *
...
#endif //MOCKTAILS_CLONING_TRACEGEN_HPP
